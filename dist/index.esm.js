...
var Alert = function Alert(props) {
  ...
  var titleClass = classNames('simple-alert-title', {
...
var useDebounce = function useDebounce(fn) {
  ...
  var fnRef = useRef(); // 页面首次渲染时利用ref保证防抖函数的唯一性
...
var AutoComplete = function AutoComplete(props) {
  ...
  var componentRef = useRef(null); // 当在组件外部进行点击时, 关闭下拉选项菜单
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        suggestions.map(function (item, index) {
          var cnams = classNames('suggestion-item', {
...
var Menu = function Menu(props) {
  ...
  var classes = classNames('simple-menu', className, {
...
var SubMenu = function SubMenu(_ref) {
  ...
  var subMenuClass = classNames('simple-submenu', {
...
var Select = function Select(props) {
  ...
  var _useState3 = useState(Array.isArray(defaultValue) ? defaultValue : []),
    _useState4 = _slicedToArray(_useState3, 2),
  ...
  var containerClass = classNames('simple-select', {
...
var Option = function Option(_ref) {
  ...
  var classes = classNames('simple-select-item', {
    'is-disabled': disabled,
...
var Tabs = function Tabs(props) {
  ...
  var tabsItemWidth = useRef(0);
  var cacheChildrenIndex = useRef([]);
  var navClass = classNames('simple-tabs-nav', {
    'nav-line': type === 'line',
    'nav-card': type === 'card',
  });
  ...
  var renderNavLinks = function renderNavLinks() {
    return Children.map(children, function (child, index) {
      ...
      var classes = classNames('simple-tabs-nav-item', {
      ...
      return /*#__PURE__*/ createElement(
        ...
        /*#__PURE__*/ createElement('div', null, ' ', childEle),
      );
    });
  };
  ...
  return /*#__PURE__*/ createElement(
    ...
    {
      style: tabStyle,
      className: 'simple-tabs '.concat(className ? classNames : ''),
    },
...
var Dragger = function Dragger(props) {
  ...
  var klass = classNames('.simple-uploader-dragger', {
